...
$('#products_table').on('click','#editar',function(){
    ...
    window.open(currentLocation+"producto_editar?id="+idproducto, "directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no, toolbar=yes,scrollbars=yes,resizable=yes,,200,width=800,height=600");
