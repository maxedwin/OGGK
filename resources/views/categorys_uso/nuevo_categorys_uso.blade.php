...
@section('titulo')
    <h4><i class="icon-cube position-left"></i> <span class="text-semibold">Nueva Categoria</span></h4>
@stop
...
@section('contenido')
    ...
    <form action="{{ route('categorys_uso_store') }}" method="POST" enctype="multipart/form-data">
