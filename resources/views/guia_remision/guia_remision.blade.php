                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="input-group ">
                                ...
                                <select id="idmotivo" class="form-control">
                                        ...
                                        <option value=5>TRASLADO ENTRE ALMACEN</option>
                            ...
                            <div class="input-group" id="group_almacen_llegada">
                                <label for="almacen_llegada">Almacén de Llegada:</label>
                                <select class="form-control" name="almacen" id="almacen_llegada" >
                                        <option value="0">--</option>
                                    @foreach ($almacenes as $almacen)
                                        <option value="{{ $almacen->idalmacen }}">{{$almacen->nombre}}</option>
                                    @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group " style="width: 100%;">
                                        ...
                                        <input type="text" class="form-control" id="partida_direccion" value="PASAJE LA RONDA NRO. 107" onkeyup="this.value = this.value.toUpperCase()">
                                    </div>
                                </div>
                            </div>
...
<script src="{{ URL::asset('/javascript/cal.js') }}" type="text/javascript"></script>
   ...
   <script>     
        $('#group_almacen_llegada').hide();

        $('#idmotivo').change(function(event) {
            if ($(this).val() ==5) {
            console.log("entra!")
                $('#group_almacen_llegada').show();
            } else {
                $('#group_almacen_llegada').hide();
            }
        })
        ...
        $('#factbol_search').keyup(function(event) {
            ...
            if(query_ov.length >  0){
                $.get(currentLocation+"buscarOVInc?query="+query_ov+"", function( data ) {
        ...
        $('#btn_guardar').click(function(event){
            ...
            if(idmotivo == 5 &&almacen_llegada==0 ){
                swal({
                    title: "Upss!",
                    text: "Debes agregar un Almacen de llegada",
                    confirmButtonColor: "#66BB6A",
                    type: "error"
                },function(){
                    //window.location.reload();
            ...
            for (i = 0, len = str.length; i < len; i++) {
                ...
                if (!(code > 47 && code < 58) && // numeric (0-9)
                    ...
                    !(code == 45 || code ==44  || code ==46 ||code ==32)&& // , - .
                    !(code ==241 || code ==209)&& //ñÑ
                    !(code==225 ||code==233||code==237||code==243||code==250)&&//lower tildes
                    !(code==193 ||code==201||code==205||code==211||code==218)) //upper tildes
                     { 
            ...
            var vali_llegada=$('#llegada_direccion').val();
            var vali_partida=$('#partida_direccion').val();

            if(is_invoice == '0' || is_invoice == 0){
                if(vali_partida.length>100 ||! isAlphaNumeric(vali_partida) ){
                swal({
                    title: "Upss!",
                    text: "La direccion del punto de partida debe ser de maximo 100 caracteres y solo letras,numeros, comas, puntos y/o guiones.Por favor corrija la direccion.",
                    confirmButtonColor: "#66BB6A",
                    type: "error"
                },function(){
                    tmp_lote=0;
            ...
            if(vali_llegada.length>100 ||! isAlphaNumeric(vali_llegada) ){
                swal({
                    title: "Upss!",
                    text: "La direccion del punto de llegada debe ser de maximo 100 caracteres y solo letras,numeros, comas, puntos y/o guiones.Por favor corrija la direccion.",
                    confirmButtonColor: "#66BB6A",
                    type: "error"
                },function(){
                    tmp_lote=0;
        ...
        $('#btn_confirmar').click(function(event){
            ...
            var texto_llegada_ubigeo = $("#llegada_ubigeo option:selected").text()
            var texto_partida_ubigeo = $("#partida_ubigeo option:selected").text()
            ...
            $.post(currentLocation+'crear_guia_remision',{idcliente:idcliente,id_orden_ventah:id_orden_ventah,igv:igv,subtotal:subtotal,descuento:descuento,medida_venta:medida_venta,total:total,comentarios:comentarios,f_entrega:f_entrega,f_cobro:f_cobro,idvendedor:idvendedor,iddespachador:iddespachador, idtransporte:idtransporte,productos:json_prod,paga:paga,vuelto:vuelto, codigoNB:codigoNB, fechaNB:fechaNB, peso_total:peso_total, almacen:almacen, almacen_llegada:almacen_llegada, idmotivo:idmotivo, is_invoice:is_invoice, transporte_tipo_doc:transporte_tipo_doc, transporte_num_doc:transporte_num_doc, transporte_denominacion:transporte_denominacion, transporte_placa:transporte_placa, transporte_chofer_tipo_doc:transporte_chofer_tipo_doc, transporte_chofer_num_doc:transporte_chofer_num_doc, envio_cod_traslado:envio_cod_traslado, envio_desc_traslado:envio_desc_traslado, envio_mod_traslado:envio_mod_traslado, envio_fec_traslado:envio_fec_traslado, envio_peso_total:envio_peso_total, partida_ubigeo:partida_ubigeo, partida_direccion:partida_direccion, llegada_ubigeo:llegada_ubigeo, llegada_direccion:llegada_direccion, observacion:observacion, texto_llegada_ubigeo:texto_llegada_ubigeo, texto_partida_ubigeo:texto_partida_ubigeo},function(data){
                ...
                if(obj[0].created == 200){
                    ...
                    if (obj[2].msg == '') {
                    ...
                    else if(parseInt(obj[5].codeG) >0 && parseInt(obj[5].codeG)<4000){
                        $('#boleta_modal').modal('hide');
                        swal({
                            title: "Error!",
                            text: "Documento rechazado, cree uno nuevo corrigiendo los errores:"+ obj[2].msg,
                            confirmButtonColor: "#66BB6A",
                            type: "error"
                        },function(){ 
                        ...
                        if( obj[6].cdr==888888888){
                            $('#boleta_modal').modal('hide');
                        swal({
                            title: "Ok!",
                            text: "En espera del CDR por parte de SUNAT. Presione el botón de recuperar documento más tarde.",
                            confirmButtonColor: "#66BB6A",
                            type: "success"
                        },function(){ 
                            if(obj[3].pdf !=null && obj[3].pdf !="")
                    ...
                    else if(obj[2].msg=="ESTADO: ESPERANDO RESPUESTA DE SUNAT"){
                        $('#boleta_modal').modal('hide');
                        swal({
                            title: "Ok!",
                            text: "Se creo el Comprobante, en espera del CDR por parte de SUNAT",
                            confirmButtonColor: "#66BB6A",
                            type: "success"
                        },function(){
                            if(obj[3].pdf !=null && obj[3].pdf !="")
                    ...
                    swal({
                        title: "Error!",
                        text: "Revisar cantidad de stock en Lote.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){ 
                        $('#btn_confirmar').prop( "disabled", false );
                    ...
                    return;
                }else if(obj[0].created == 998){
                    $('#boleta_modal').modal('hide');
                    swal({
                        title: "Error!",
                        text: "Los productos no coinciden con la Orden de Venta.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){ 
                        $('#btn_confirmar').prop( "disabled", false );
                    ...
                    return;
                }else if(obj[0].created == 997){
                    $('#boleta_modal').modal('hide');
                    swal({
                        title: "Error!",
                        text: "La cantidad de los productos es mayor a los registrados en la Orden de Venta.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){ 
                        $('#btn_confirmar').prop( "disabled", false );
                    ...
                    $('#boleta_modal').modal('hide');
                    console.log(obj[2].leer_respuesta['errors']);
                    swal({
                        title: "Error!",
                        text: obj[2].leer_respuesta['errors'],
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){ 
                        $('#btn_confirmar').prop( "disabled", false );
                    ...
                    if(parseInt(obj[0].codeG)== 4000){
                        $('#boleta_modal').modal('hide');
                        swal({
                            title: "Error!",
                            text: "Ya existe un comprobante con ese código en SUNAT",
                            confirmButtonColor: "#66BB6A",
                            type: "error"
                        },function(){ 
                            $('#btn_confirmar').prop( "disabled", false );
                    ...
                    swal({
                        title: "Error!",
                        text: "La conexión con Sunat no fue exitosa "+obj[0].msg,
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){ 
                        $('#btn_confirmar').prop( "disabled", false );
                    ...
                    swal({
                        title: "Error..!",
                        text: "No se puede guardar la Guia de Remisión, intentalo de nuevo luego.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){
                        $('#btn_confirmar').prop( "disabled", false );
