                    ...
                    <div class="col">
                        <h4 class="guia_remision">
                            <?php if($guia_remision->correlativo_inside == 0) { ?>
                                <div>CONTENIDO DE GUÍA</div>
                                <div><?PHP echo $guia_remision->codigoNB;//echo str_pad($sucursal->serie, 2, "0", STR_PAD_LEFT);?><?PHP //echo str_pad($guia_remision->numeracion, 6, "0", STR_PAD_LEFT);?></div>
                            <?php } else { ?>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    @for ($i = 0; $i < count($guia_remisionD); $i++)
                            <tr>
                                ...
                                <td class="text-center">  {{ $guia_remisionD[$i]->codigo }} </td>
                                <td class="text-center">  {{ $guia_remisionD[$i]->f_venc }} </td>
                            </tr>
                    @endfor
                    </tbody>
                    <tfoot>
