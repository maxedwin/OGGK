...
@section('titulo')
    <h4><i class="glyphicon glyphicon-usd position-left"></i> <span class="text-semibold">Listado de Fichas de Recepción</span></h4>
@stop
...
@section('breadcrumb')
    ...
    <!-- <li>Inventario</li> -->
    <li class="active"><a href="/listado_caja"></i>Fichas de Recepción</a></li>
@stop
<!-- MENU AUXLIAR -->
