...
@section('titulo')
    <h4><i class="glyphicon glyphicon-send position-left"></i> <span class="text-semibold">Crear Guía de Traslado</span></h4>
@stop
...
@section('breadcrumb')
    ...
    <li class="active">Crear Guía de Traslado </li>
@stop
<!-- MENU AUXLIAR -->
                ...
                <div class="panel panel-flat">
                    <div class="panel-body">
                        ...
                        <div class="form-group form-inline hidden">
                            <div class="input-group ">
                                <label for="is_invoice">¿Generar Guía de Traslado Electrónica?</label>
...
<script src="{{ URL::asset('/javascript/cal.js') }}" type="text/javascript"></script>
   ...
   <script>
            ...
            $.post(currentLocation+'crear_guia_traslado',{idcliente:idcliente,id_orden_ventah:id_orden_ventah,igv:igv,subtotal:subtotal,descuento:descuento,medida_venta:medida_venta,total:total,comentarios:comentarios,f_entrega:f_entrega,f_cobro:f_cobro,idvendedor:idvendedor,iddespachador:iddespachador, idtransporte:idtransporte,productos:json_prod,paga:paga,vuelto:vuelto, codigoNB:codigoNB, fechaNB:fechaNB, peso_total:peso_total, almacen:almacen, idmotivo:idmotivo, is_invoice:is_invoice, transporte_tipo_doc:transporte_tipo_doc, transporte_num_doc:transporte_num_doc, transporte_denominacion:transporte_denominacion, transporte_placa:transporte_placa, transporte_chofer_tipo_doc:transporte_chofer_tipo_doc, transporte_chofer_num_doc:transporte_chofer_num_doc, envio_cod_traslado:envio_cod_traslado, envio_desc_traslado:envio_desc_traslado, envio_mod_traslado:envio_mod_traslado, envio_fec_traslado:envio_fec_traslado, envio_peso_total:envio_peso_total, partida_ubigeo:partida_ubigeo, partida_direccion:partida_direccion, llegada_ubigeo:llegada_ubigeo, llegada_direccion:llegada_direccion, observacion:observacion, texto_llegada_ubigeo:texto_llegada_ubigeo, texto_partida_ubigeo:texto_partida_ubigeo},function(data){
                ...
                if(obj[0].created == 200){
                    ...
                    if (obj[2].msg == '') {
                        ...
                        window.open(currentLocation+"info_guia_traslado?id="+ obj[1].id,  "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,,200,width=1000,height=600");
                        window.location.reload();
                    }
                    ...
                    swal({
                        title: "Error..!",
                        text: "No se puede guardar la Guia de Traslado, intentalo de nuevo luego.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){
                        $('#btn_confirmar').prop( "disabled", false );
        ...
        function calculateTotalPeso() {
            ...
            if(  !peso_total_total== 0 || !$('#envio_peso_total').val()){
