...
<script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
   ...
   crossorigin=""></script>
    <h4><i class="icon-users2 position-left"></i> <span class="text-semibold">Listado de Clientes Potenciales</span></h4>
@stop
...
@section('breadcrumb')
    ...
    <!-- <li>Inventario</li> -->
    <li class="active"><a href="/list_potenciales"></i>Listado de Clientes Potenciales</a></li>
...
<script src="https://cdn.rawgit.com/wenzhixin/multiple-select/e14b36de/multiple-select.js"></script>
    <div class="from-group buttonsToHide" id="marcas_group" style="position:absolute;bottom:-60px; right:250px;z-index: 100">
                                ...
                                <select id="ms" multiple="multiple">                                                                  
                                        <option value="0" selected>Nombre Comercial</option>
                                        <option value="1" selected>Contacto Telefono</option>
                                        <option value="2" selected>Direccion</option>
                                        <option value="3" selected>Distrito</option>
                                        <option value="4" selected>Provincia</option>
                                        <option value="5" selected>Vendedor</option>
                                        <option value="6" selected>Creador</option>
                                        <option value="7" selected>Creado</option>
                                        <option value="8" selected>Dias_para nueva_visita</option>
            ...
            <table class="table datatable-column-search-inputs dataTable table-hover dataTable no-footer" style="overflow-x:auto;" id="cliente_table">
                ...
                @foreach ($clientes as $cliente)
                    <tr id="tr_detalle">
                        ...
                        <td style="background-color:{{$color}} ">{{ $cliente->nombre_comercial }}</td>
                        ...
                        <button type="button" class="btn btn-success btn-xs"
                                    data-idcliente     = "{{$cliente->idpotencial}}"                                    
                        ...
                        <button type="button" class="btn btn-success btn-xs"
                                    data-idcliente    ="{{$cliente->idpotencial}}"
                                    id="promover" >
                                <i class="glyphicon glyphicon-open position-center"></i>
                            </button>
                            ...
                            <fieldset style="z-index:100;">
                                ...
                                <div class="form-group form-inline">                                  
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nombre_comercial" class="form-control" disabled> 
                                        <input type="hidden" id="idcliente" class="form-control" disabled> 
                                    </div>
                                </div>
...
$(function() {
    ...
    $('#cliente_table').on('click','#tr_detalle #td_actions #promover',function(events){
        var idcliente = $(this).data('idcliente');
        window.open(currentLocation+"promover_potencial?idcliente="+idcliente, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,,200,width=800,height=600");
    });


    $('#cliente_table').on('click','#tr_detalle #td_actions #editar',function(events){
        var idcliente = $(this).data('idcliente');
        window.open(currentLocation+"editar_potencial?idcliente="+idcliente, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,,200,width=800,height=600");
    });
    ...
    $('#cliente_table').on('click','#tr_detalle #td_actions #eliminar',function(events){
        ...
        function(isConfirm){
            if (isConfirm) {
                var jqxhr =  $.get(currentLocation+"eliminar_potencial?idcliente="+idcliente, function(data,status){})
                .done(function() {
                    swal({
                        title: "Eliminado!",
    ...
    <script type="text/javascript">
        ...
        $('#formulario').on('click','#guardar_cambios',function(){
            ...
            arrayPost = {idcliente:idcliente, tipo_llamada:tipo_llamada, tipo:tipo, respuesta:respuesta,latitud:selectedLatLng.lat, longitud:selectedLatLng.lng, potencial:potencial};
