...
@section('titulo')
    <h4><i class="glyphicon glyphicon-usd position-left"></i> <span class="text-semibold">Listado de Ordenes de Venta</span></h4>
@stop
...
@section('breadcrumb')
    ...
    <!-- <li>Inventario</li> -->
    <li class="active"><a href="/listado_caja"></i>Ordenes de Venta</a></li>
@stop
<!-- MENU AUXLIAR -->
