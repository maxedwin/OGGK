    ...
    <script>
        ...
        $('#lista').on('click','#btn_agregar',function(event){
            ...
            var producto = _.find(Lproductos,{idproducto : idproducto });
                ...
                string += '<td id="lote"><input class="form-control" type="text" id="input_lote" name="input_lote"> @if ($errors->has('input_lote')) <div class="error">{{ $errors->first('input_lote') }}</div> @endif </td>';
...
//        FUNCIONDE BOTONES CAMBIO DE ESTILOS DIV PRODUCTOS
        ...
        $('#btn_guardar').click(function(event){
            ...
            $.post(currentLocation+'crear_entrada',{productos:json_prod, almacen:almacen, razon:razon, f_emision:f_emision, tipo_mov:tipo_mov},function(data){
                ...
                if(mensaje === 200){
                    ...
                    swal({
                        title: "NO!",
                        text: "Error! Datos incompletos. Revisa por favor.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){  });
                    return;
                    ...
                    swal({
                        title: "Error..!",
                        text: "No se puede guardar la entrada, intentalo de nuevo luego.",
                        confirmButtonColor: "#66BB6A",
                        type: "error"
                    },function(){});
                    return;
